    ...
    <div class="py-main">
        <div class="container container-sm">
            ...
            <div class="box-general diff-so shadow">
                <div class="heading">
                    <h3><a href="{{route('options_game')}}" class="back"><img src="{{ asset('frontend/img/pinpoint/icon/ic-left.svg')}}" class="img-fluid img-icon" alt="Icon"></a> Games</h3>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-box p-4">
                            {!! Form::open(array('route' => 'game_store','method'=>'POST')) !!}
                            ...
                            <div class="form-group sidebar-form my-3">
                                <label for="game_time" class="text-sm">Date</label>
                                {!! Form::date('game_time', null, array('class' => 'form-control')) !!}
                                {!! $errors->first('game_time', '<small id="titleHelp" class="form-text text-danger">:message</small>') !!}
                            </div>
