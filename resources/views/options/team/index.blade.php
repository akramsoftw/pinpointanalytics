        ...
        <div class="container container-sm">
            ...
            <div class="box-general diff-so shadow">
                <div class="heading">
                    <div class="row">
                        <div class="col-6">
                            <h3><a href="{{route('options_index')}}" class="back"><img src="{{ asset('frontend/img/pinpoint/icon/ic-left.svg')}}" class="img-fluid img-icon" alt="Icon"></a> Teams</h3>
                        </div>
                        <div class="col-6">
                            <a href="{{route('team_create')}}" class="btn btn-sm btn-success float-right">Add Team</a>
                        </div>
                    </div>
                </div>
                        ...
                        <tbody>
                            @foreach($teams as $team)
                                <tr>
                                    <td>{{ $team->name }}</td>
                                    <td>
                                        <a href="{{route('team_show', $team->id)}}" class="btn btn-sm btn-success btn-action">show</a>
                                        <a href="{{route('team_edit', $team->id)}}" class="btn btn-sm btn-warning btn-action">Edit</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
